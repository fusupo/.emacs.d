...
#+begin_src emacs-lisp
  (use-package js2-mode
    ...
    (progn
      ...
      ;; (add-hook 'js2-mode-hook (lambda () (smartparens-strict-mode t)) t)
      ;; (add-hook 'js2-mode-hook (lambda () (show-smartparens-mode t)) t)
      ;; (add-hook 'js2-mode-hook (lambda () (setq js2-basic-offset 2)) t)
