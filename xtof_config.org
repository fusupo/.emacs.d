...
#+BEGIN_SRC emacs-lisp
  (use-package smart-mode-line
    ...
    :config (progn
              ...
              (setq sml/folder '(:inherit sml/global :background "#091f2e" :foreground "gray40" :weight normal))
              (setq sml/modes '(:inherit sml/global :background "#0a3749" :foreground "gray65"))
              (setq sml/position-percentage '(:inherit sml/prefix :background "#0a3749" :foreground "gray100" :weight normal))
              (setq sml/vc '(:inherit sml/git :background "#0a3749" :foreground "#2aa889"))
              (setq sml/vc-edited '(:inherit sml/prefix :background "#0a3749" :foreground "OrangeRed1"))
              (sml/setup)))
#+END_SRC
