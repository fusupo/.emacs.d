...
#+begin_src emacs-lisp
  (use-package smartparens
    ...
    (progn
      ...
      ;; PAREDIT STYLE
      (define-key sp-keymap (kbd "C-S-9") 'sp-forward-slurp-sexp)
      (define-key sp-keymap (kbd "C-S-]") 'sp-forward-barf-sexp)
      (define-key sp-keymap (kbd "C-S-0") 'sp-backward-slurp-sexp)
      (define-key sp-keymap (kbd "C-S-[") 'sp-backward-barf-sexp)
